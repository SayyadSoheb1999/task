...
function EditCompo() {
    ...
    return (
       ...
       <br/>
       <Link style={{marginLeft:'650px'}} to='/'  onClick={()=>{input.title.length>0 && input.desc.length>0 && input.exp.length>0  ? handleEdit(input) : console.log('required') }} className='btn btn-success'>Edit</Link>
